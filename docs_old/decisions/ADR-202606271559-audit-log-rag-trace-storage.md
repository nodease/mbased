# ADR-202606271559: audit_logs와 RAG Trace 저장 기준
...
- 추적/감사 아키텍처: [architecture/tracing-audit.md](../architecture/tracing-audit.md)
- API 계약: [api/tracing-audit.md](../api/tracing-audit.md)
