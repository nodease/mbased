# ADR-202606290116: RBAC auth_state 및 User Direct Permission 승인
...
- [ADR-202606271559-auth-state-standard](ADR-202606271559-auth-state-standard.md)
- [ADR-202606271559-user-direct-permission](ADR-202606271559-user-direct-permission.md)
...
- LLM credential API: [api/llm-credentials.md](../api/llm-credentials.md)
