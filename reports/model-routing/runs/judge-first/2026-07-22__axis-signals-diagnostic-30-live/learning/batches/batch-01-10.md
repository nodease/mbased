...
- 실행 시각: 2026-07-21T21:08:39.240834+00:00
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 자동 라우팅 | $0.018513 | $0.020360 | $0.038873 | 9042ms | 9238ms | 미평가 | 100.0% | - |
...
- Judge label 누적: 10건
- 실제 선택 모델 종류: 5개 ({'gpt-4o-mini': 3, 'gpt-4.1': 3, 'gpt-5.4-mini': 1, 'gpt-5-mini': 1, 'gpt-4.1-mini': 2})
- 처리 출처 분포: {'runtime_judge': 10}
- 로컬 라우터가 Judge 없이 직접 선택한 횟수: 0회
- 로컬 라우터가 자신 없어 Judge로 되돌린 횟수: 0회
- Judge 신뢰도 평균 / P95: 0.927 / 0.960
