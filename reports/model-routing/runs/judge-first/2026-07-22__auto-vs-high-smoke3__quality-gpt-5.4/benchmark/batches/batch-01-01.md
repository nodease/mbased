...
이 단계는 학습에 쓰지 않은 1개 요청을 자동 라우팅, 고가 모델 고정에 똑같이 보내 비용·속도·품질을 비교합니다.

- 자동 라우팅 총 제품 비용: $0.002537
- 고가 고정 대비 자동 라우팅 순절감: $0.009503 (절감)
- 중간 고정 비교: 이번 실행에서 제외
- 저가 고정 비교: 이번 실행에서 제외
...
- 실행 시각: 2026-07-21T23:01:15.985464+00:00
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 자동 라우팅 | $0.000147 | $0.002390 | $0.002537 | 4981ms | 5160ms | 41.0 | 100.0% | 0.0% |
| 고가 고정 (gpt-5.6-sol) | $0.012040 | $0.000000 | $0.012040 | 8030ms | 8266ms | 93.0 | 100.0% | 100.0% |
...
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 1 | holdout_product_help | economy | gpt-4o-mini | 41.0 | $0.002537 | 93.0 | $0.012040 |
