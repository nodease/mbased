# Judge-first 자동 모델 라우팅 1회 학습 검증 보고서

## 한눈에 보는 결론

이 단계는 자동 라우팅만 1회 실행해 첫 50건으로 학습하고 다음 50건으로 일반화 성능과 학습 버전 발행 여부를 확인합니다.

- 자동 라우팅 총 제품 비용: $0.003034
- 고가 고정 비교: 이번 실행에서 제외
- 중간 고정 비교: 이번 실행에서 제외
- 저가 고정 비교: 이번 실행에서 제외
...
- 실행 시각: 2026-07-21T19:25:33.425628+00:00
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 자동 라우팅 | $0.001235 | $0.001799 | $0.003034 | 18330ms | 18641ms | 미평가 | 100.0% | - |
...
| ---: | --- | --- | --- | ---: | ---: |
| 1 | refund_intent | economy | gpt-5-mini | 미평가 | $0.003034 |
